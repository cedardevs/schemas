...
public class MultiLineString extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4208371877308719737L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MultiLineString\",\"namespace\":\"org.cedar.psi.common.avro\",\"doc\":\"An array of separate linestrings. A linestring is an array of two or more CONNECTED positions, each described with two values: longitude then latitude. A third (optional) value for elevation is allowed per position. Linestrings may self-cross.\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"MultiLineStringType\",\"symbols\":[\"MultiLineString\"]}},{\"name\":\"coordinates\",\"type\":{\"type\":\"array\",\"items\":[{\"type\":\"array\",\"items\":[{\"type\":\"array\",\"items\":\"double\"}]}]},\"default\":[]}]}");
   ...
   */
  public MultiLineString(MultiLineStringType type, java.util.List<Object> coordinates) {
    this.type = type;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: type = (MultiLineStringType)value$; break;
   ...
   */
  public static MultiLineString.Builder newBuilder() {
   ...
   * @return A new MultiLineString RecordBuilder
   */
  public static MultiLineString.Builder newBuilder(MultiLineString.Builder other) {
    return new MultiLineString.Builder(other);
  }
   ...
   * @return A new MultiLineString RecordBuilder
   */
  public static MultiLineString.Builder newBuilder(MultiLineString other) {
    return new MultiLineString.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MultiLineString>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(MultiLineString.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(MultiLineString other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public MultiLineString.Builder setType(MultiLineStringType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public MultiLineString.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public MultiLineString.Builder setCoordinates(java.util.List<Object> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public MultiLineString.Builder clearCoordinates() {
      coordinates = null;
    ...
    public MultiLineString build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (MultiLineStringType) defaultValue(fields()[0]);
