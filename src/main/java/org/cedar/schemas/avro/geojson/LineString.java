...
public class LineString extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1437021034901967659L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LineString\",\"namespace\":\"org.cedar.psi.common.avro\",\"doc\":\"An array of two or more CONNECTED positions, each described with two values: longitude then latitude. A third (optional) value for elevation is allowed per position. A LineString may self-cross.\",\"fields\":[{\"name\":\"type\",\"type\":{\"type\":\"enum\",\"name\":\"LineStringType\",\"symbols\":[\"LineString\"]}},{\"name\":\"coordinates\",\"type\":{\"type\":\"array\",\"items\":[{\"type\":\"array\",\"items\":[\"double\"]}]},\"default\":[]}]}");
   ...
   */
  public LineString(LineStringType type, java.util.List<Object> coordinates) {
    this.type = type;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: type = (LineStringType)value$; break;
   ...
   */
  public static LineString.Builder newBuilder() {
   ...
   * @return A new LineString RecordBuilder
   */
  public static LineString.Builder newBuilder(LineString.Builder other) {
    return new LineString.Builder(other);
  }
   ...
   * @return A new LineString RecordBuilder
   */
  public static LineString.Builder newBuilder(LineString other) {
    return new LineString.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineString>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(LineString.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(LineString other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.type)) {
        this.type = data().deepCopy(fields()[0].schema(), other.type);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineString.Builder setType(LineStringType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LineString.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public LineString.Builder setCoordinates(java.util.List<Object> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public LineString.Builder clearCoordinates() {
      coordinates = null;
    ...
    public LineString build() {
      try {
        ...
        record.type = fieldSetFlags()[0] ? this.type : (LineStringType) defaultValue(fields()[0]);
